        ...
        Restaurant(
          ...
          StandardSchedule( // TODO create StandardSchedule.carryOutAndDelivery(
            deliveryHours = HoursOfOperation(
              ...
              monday = Hours("16:00", "20:00"),
              tuesday = Hours("16:00", "20:00"),
            ...
            carryOutHours = HoursOfOperation(
              sunday = Hours("12:00", "20:00"),
              monday = Hours("12:00", "20:00"),
              tuesday = Hours("12:00", "20:00"),
              wednesday = Hours("12:00", "20:00"),
              thursday = Hours("12:00", "20:00"),
              friday = Hours("12:00", "20:00"),
              saturday = Hours("12:00", "20:00"),
            ),
          ),
        ),
        Restaurant(
